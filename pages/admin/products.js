export const viewAdminProducts = () => {
  const a = `
  <div class="container-fluid ">
            ...
            <nav
                ...
                <div class="container-fluid m0 p0">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 w100 ">
                        ...
                        <li class="nav-item ">
                            <a id="tabCategories" class="nav-link btn btn-outline-info" aria-current="page"
                                href="adminCategories.html">
                                <span>
                        ...
                        <li class="nav-item">
                            <a id="tabCustomer" class="nav-link btn btn-outline-info" aria-current="page" href="#">
                                <span>
                        ...
                        <li class="nav-item">
                            <a id="tabTransports" class="nav-link btn btn-outline-info" aria-current="page" href="#">
                                <span>
                        ...
                        <li class="nav-item dropdown">
                            <a id="tabStatisticals" class="nav-link btn btn-outline-info dropdown-toggle"
            ...
            <div class="container-fluid mt-2 p0 pl-10px h-auto">
                <div class="container-show h100 ">
                    <div class="d-flex flex-column h100">
                        ...
                        <div class="container-fluid">
                            <table class="table  table-hover" id="listPro">
                                <thead>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="collapse multi-collapse"  id="multiCollapseExample1">
                                            ...
                                            <div class="card card-body">
                                                <form id="addNewForm">
                                                    <h2 class="text-">Add new product</h2>
                                                    <div class="">
                                                        <label for="exampleInputPassword1" class="form-label" required>Product
                                                            Name</label>
                                                        <input type="text" class="form-control" id="namePro" value="">
                                                    </div>
                                                    <div class="">
                                                        <label for="exampleInputPassword1"
                                                            class="form-label d-flex">Image
                                                            <!-- <button id="uploadButton" class="rounded-3 ml-1 btn-outline-info" aria-current="page">Up file</button> -->
                                                        </label>
                                                        <input type="text" class="form-control" id="imagePro"
                                                            placeholder="'anylink image' or '../Images/prd-shirt01.png'">
                                                        <!-- <button id="upload-button">Up file</button> -->
                                                    </div>
                                                    <div class="mt-2 mb-1 d-flex flex-column justify-content-start">
                                                        <label for="productCategory" class="form-label  d-flex" >Category
                                                            <select id="selectCatePro" name="productCategory" class="rounded-3 btn-outline-info bg-light text-dark w80 ml-1">
                                                                <option value="" class="bg-light rounded-3 " disabled selected > Select one</option>
                                                                <option value="" class="bg-light rounded-3 " >Add new above </option>
                                                                <!-- <option value="Phân Loại 2" class="bg-light rounded-3 " >Phân Loại 2</option>
                                                                <option value="Phân Loại 3" class="bg-light rounded-3 " >Phân Loại 3</option> -->
                                                                <!-- Thêm danh sách phân loại từ máy chủ ở đây nếu cần -->
                                                            </select>
                                                        </label>
                                                        <input type="text" class="form-control" id="inputCatePro" placeholder="Add new category">
                                                    ...
                                                    <div class="">
                                                        <label for="exampleInputPassword1" class="form-label">Product
                                                            Price</label>
                                                        <input type="number" class="form-control" id="pricePro">
                                                    </div>
                                                    <div class="mb-1">
                                                        <label for="exampleInputPassword1"
                                                            class="form-label">Description</label>
                                                        <input type="text" class="form-control" id="desPro">
                                                    </div>
                                                    ...
                                                    <div class=" d-flex">
                                                        <button type="submit" id="btnSubmit"
                                                            ...
                                                            aria-current="page">Add product</button>
                                                        <button type="button"
                                    ...
                                    <div class="col">
                                        <div class="collapse multi-collapse" id="multiCollapseExample2">
                                            <div class="card card-body">
                                                <form id="updateForm">
                                                    <h2 class="text-">Update product</h2>
                                                    <div class="">
                                                        <label for="exampleInputPassword1" class="form-label">Product
                                                            Name</label>
                                                        <input type="text" class="form-control" id="updateNamePro">
                                                    </div>
                                                    <div class="">
                                                        <label for="exampleInputPassword1" class="form-label">Product
                                                            Image</label>
                                                        <input type="text" class="form-control" id="updateImagePro"
                                                            placeholder="'anylink image' or '../Images/prd-shirt01.png'">
                                                    </div>
                                                    <div class="">
                                                        <label for="productCategory" class="form-label  d-flex" >Category
                                                            <select id="selectUpCatePro" name="productCategory" class="rounded-3 btn-outline-info bg-light text-dark w80 ml-1">
                                                                <option value="" class="bg-light rounded-3 " disabled selected > Select one</option>
                                                                <option value="" class="bg-light rounded-3 " >Add new above </option>
                                                                <option value="Phân Loại 2" class="bg-light rounded-3 " >Phân Loại 2</option>
                                                                <option value="Phân Loại 3" class="bg-light rounded-3 " >Phân Loại 3</option>
                                                        ...
                                                        <input type="text" class="form-control" id="inputUpCatePro" placeholder="Update category">
                                                        <!-- <label for="exampleInputPassword1" class="form-label">Product
                                                            Category</label> 
                                                            <input type="text" class="form-control" id="updateCategoryPro"> -->
                                                    </div>
                                                    <div class="">
                                                        <label for="exampleInputPassword1" class="form-label">Product
                                                            Price</label>
                                                        <input type="number" class="form-control" id="updatePricePro">
                                                    </div>
                                                    <div class="mb-1">
                                                        <label for="exampleInputPassword1"
                                                            class="form-label">Description</label>
                                                        <input type="text" class="form-control" id="updateDesPro">
                                                    </div>
        ...
        <script type="module" src="../src/modules/adminProduct.js"></script>
    </div>
  `;
  return a;
};
